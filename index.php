...
<div id="page" class="site">
		...
		<header class="hero-banner" id="header">
            ...
            <?php
                if(!isset($_COOKIE['portfolio_visit'])) {
                    $skills = json_decode(get_option('p_author_skills'));
                    get_template_part('template-parts/landing-banner', null, ["words" => $skills]);
                }
            ?>
			...
			<div class="hero-banner--bottom-wrapper">
                ...
                <a class="hero-banner--bottom-btn arrow-btn no-phone" href="#author">
        ...
        <section class="author-section p-h-box" id="author">
            ...
            <div class="author-section--portrait">
                <svg viewBox="0 0 63 128" fill="none" xmlns="http://www.w3.org/2000/svg" class="cat-decorator">
            ...
            <!--            REVIEW           -->
            <svg viewBox="0 0 597 466" fill="none" class="cat-decorator author-section--top-decorator">
            ...
            <!--            REVIEW           -->
            <svg  viewBox="0 0 142 144" fill="none" class="cat-decorator author-section--bottom-decorator">
        ...
        <section class="content-box">
            ...
            <footer class="content-box--footer">
                <a href="#header">
                    <svg width="29" height="39" viewBox="0 0 29 39" fill="none" class="arrow-btn">
